...
#
# If .claude/skills or .codex/skills are not directories (e.g., text files containing
# the symlink path), this script will copy .agents/skills to those directories.
...
# Set up .claude/skills and .codex/skills
