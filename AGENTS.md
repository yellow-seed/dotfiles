...
│   │   ├── 03-profile.sh      # プロファイル固有Brewfile適用
│   │   ├── 03-profile.bats    # プロファイルテスト
│   │   ├── setup.sh           # macOSセットアップオーケストレーター
│   │   ├── setup.bats         # setup.shテスト
...
- **03-profile.sh**: プロファイル固有Brewfileの適用
- **setup.sh**: macOS用セットアップオーケストレーター
